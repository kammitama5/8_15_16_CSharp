...
namespace Pyth
{
    class Pyth
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The angle between the two points is " + Math.Round(degrees, 3));

            Console.WriteLine("The distance between the two points ie Hypotenuse is " + Math.Round(Pyth, 2));
        }
    }
}
